 ...
 *
 * The Popover is a view that floats above an app鈥檚 content. Popovers provide an
 ...
 *   of the format  `variable in expression` 鈥� where variable is the user defined loop variable
 ...
 *
 * Note that because we are caching these views, *we aren鈥檛 destroying scopes*. Instead, scopes
